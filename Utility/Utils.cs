...
namespace Common
{
    ...
    public class Utils
    {
        ...
        /// stream可以实现分块读取
        /// </summary>
        /// <param name="strFilePath">传入大文件地址</param>
        /// <returns>返回所有内容</returns>
        public static string BigFileRead(string strFilePath = null)
        {
            if (strFilePath == null)
            {
                strFilePath = @"E:\20160603.log";
            }
        ...
        public static string RunCmd(string str)
        {
            ...
            try
            {
                ...
                result = Regex.Match(output, $"([0-9]+?){System.Environment.NewLine}").Groups[1].Value;
